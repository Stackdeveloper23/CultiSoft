...
<html lang="en">
    ...
    <!--Nav lateral-->
         <div class="nav">
                    ...
                    <a class="nav-link" href="crudproductos.php">Productos</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <!--Titulo-->
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                En esta pagina prodras administrar los produtos
                            </div>
                        </div>
                       
             <div class="container">
	                    <h1 class="page-header text-center">CRUD PHP Productos</h1>
	            <div class="row">
			...
			try{	
				...
				foreach ($db->query($sql) as $row) {
					...
					<tr>
						...
						<?php include('actualizarborrarproducto.php'); ?>
					</tr>
					<?php 
				}
			}

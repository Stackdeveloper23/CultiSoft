...
<!--Botton usuario-->
              <button type="button" class="btn btn-primary" id="btnNombreApellidos"><?php
...
<!-- seccion carrusel-->
  ...
  <section class="page-section" style="background-color: #1abc9c; ">
    <div class="row" id="carrusel">

      <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="./img/images/carrusel3.jpg" class="w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="./img/images/carrusel1.jpg" class="w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="./img/images/carrusel2.jfif" class="w-100" alt="...">
          </div>
        </div>
  ...
  <section class="page-section" id="seccion_product">
    <div class="container">
      <h2 class="text-center mb-5"  id="titulo_productos" >PRODUCTOS MAS VENDIDOS</h2>
      <div class="row row-cols-3 ">

        <!-- item1-->
      <?php foreach ($resultado as $row) {?>
        <div class="col" id="contenedor_card" >
          <div class="card text-success" id="card" style="width: 18rem;">
          <?php 
          $id = $row['id'];
...
<!--
  <section class="page-section" style="background-color: #1abc9c; ">
    <div class="row" id="carrusel">
      ...
      <div id="titulo_carrusel"><h2 class="text-center mb-5"  style="color: green;">PROMOCIONES</h2></div>
      <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="./img/images/carrusel3.jpg" class="w-100" alt="...">
 ...
 <section class="container pt-5">
  ...
  <div class="col-md-6 col-lg-6 mb-3" style="height: 200px;">
  <div class="card mb-3" style="max-width: 540px;">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="./img/images/RoseCard.jpg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
  ...
  <div class="row g-0">
    <div class="col-md-4">
      <img src="./img/images/flores_sanValentin.png" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
 ...
 <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"
  ...
  <!--script boton username-->

<script>
  const btnNombreApellidos = document.getElementById('btnNombreApellidos');

  if (btnNombreApellidos.textContent === '') {
    btnNombreApellidos.style.display = 'none';
  }
</script>
